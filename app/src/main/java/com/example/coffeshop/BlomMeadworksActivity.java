...
public class BlomMeadworksActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerBMtimeslots = findViewById(R.id.spinnerBMtimeslots);
        ArrayAdapter<CharSequence> adapterBMtimeslots = ArrayAdapter.createFromResource(this,R.array.timeslots, android.R.layout.simple_spinner_item);
        adapterBMtimeslots.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerBMtimeslots.setAdapter(adapterBMtimeslots);
